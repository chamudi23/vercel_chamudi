    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Module 4 — Automated Analysis (Chamudi) — ACTIVE */}
          <Link to="/skeletal" className="bg-slate-800 rounded-2xl p-6 border border-slate-700 hover:border-orange-500 transition-all group block">
            <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex items-center justify-between">
              <span className="text-slate-500 text-xs">Chamudi</span>
              <span className="text-orange-400 text-xs group-hover:translate-x-1 transition-transform">Open Module →</span>
            </div>
          </Link>
