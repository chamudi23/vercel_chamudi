 ...
 * - Per-bone visual measurement guides
 * - Validates numeric and select inputs
 *
 * The measurements are stored in AnalysisContext; the full analysis is
 * persisted once, at Step 3, via analysisStore (the `analyses` table).
 */
