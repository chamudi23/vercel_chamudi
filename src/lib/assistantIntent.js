...
function isHelpQuestion(text) { return /\b(how(?: do i| can i| to)?|guide me|show me how|where can i|where do i|what does|what can|steps?|instructions?|help me (?:to|with)|walk me through)\b/.test(text) && /\b(add|create|upload|attach|edit|update|change|search|use|viewer|coverage|assistant|specimen|image|measurement|documentation|record)\b/.test(text) }
